...
#-----------------------------------<<< About >>>------------------------------------ #
def about():
    messagebox.showinfo('Details','Develop by ' ' ----> ' ' Hrishikesh Pandey\n '  ' \nApplication Verson 1.0')
            ...
            if null == password_length:
                ...
                if check == 1:
                    ...
                    def give():
                        ...
                        votewin.geometry('500x650+450+25')
            ...
            if votingstatus=='Not Voted':
                ...
                def give():
                    ...
                    if v3=='BJP' or v3=='TMC' or v3=='Congress':
                        ...
                        cpp_l.place(x=213,y=310)
                        #gvote_bg=PhotoImage(file='button/verify.png')
                        gvote=Button(gv2,text=' Resend ',fg='white',font=('Regular',15),bd=0,bg='#1BB3A5',cursor='hand2',padx=10,command=give)
